...
$(document).ready(function () {
    ...
    function updateShop() {
        ...
        $("#home-shop-column").append('<div class="flex-container" id="rarecandy"><div class="flex-item1"><input type="checkbox" class="checkbox" onmousedown="bleep.play()" ></div><div class="flex-item2"><img src="pictures/rare-candy.png" alt="Rare Candy Picture">+1 Level</div><div class="flex-item3"><div class="flex-container-shop"><div id="nugget-count">100</div><img src="pictures/nugget.png" alt="PokePlanner Currency Icon"> </div></div><div class="flex-item3"><div class="btn-group"><button type="button" class="btn btn-danger dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" ><span class="sr-only">Toggle Dropdown</span></button><div class="dropdown-menu"><button type="button" class="btn btn-light btn-sm delete-button dropdown-item" >Delete</button></div></div></div></div>')
